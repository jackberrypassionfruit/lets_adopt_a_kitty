"""
Django settings for kitty_website project.
...
SECRET_KEY = "django-insecure-7lhhu^qxc1b5pg@!xorpe%+&98ptl&!t)f2i(jn3_z_-%n*&s-"
...
WSGI_APPLICATION = "kitty_website.wsgi.application"
